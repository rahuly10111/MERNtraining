...
export default function LoginUser() {
    ...
    function SubmitLoginForm() {
        dispatch(LoginUserData(userlogindata)).then(() => navigate(`/dasboard`));
        swal("Data Added!", "User Login Success!", "success");
    }
        ...
        <>
            <form className="form">
                ...
                <div className="field">
                    ...
                    <input autoComplete="off" placeholder="Username" className="input-field" type="text" name='email' value={userlogindata.email} onChange={ChangeFormValue} required />
                </div>
                <div className="field">
                    <svg className="input-icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
